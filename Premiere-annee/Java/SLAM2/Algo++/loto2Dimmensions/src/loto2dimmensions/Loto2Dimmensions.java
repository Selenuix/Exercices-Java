...
public class Loto2Dimmensions {
    ...
    public static void main(String[] args) {
        ...
        int freq1[];
        int i, j, t, n, nb, max, iMax = 0, choix, semaine;
        String resultat;

        do {
            System.out.println("\n1- Exercice a");
            System.out.println("2- Exercice b");
            System.out.println("3- Exercice c");
            System.out.println("4- Exercice d");
            System.out.println("5- Exercice e");
            ...
            switch (choix) {
                ...
                case 4:
                    ...
                    // Parcours du tableau
                    for(i = 0; i <= 155; i++) {
                        // Ajout des valeurs au tableau freq1
                        for(j = 0; j <= 4; j++) {
                            nb = loto[i][j];
                            freq1[nb]++;
                        }
