...
{
	// Constructeur
	public FretMaritime(String villeDepart, String villeArrivee, int duree, int distance, TypeVehicule leTypeVehicule)
	{
	...
	public float calculerEmpreinteCarbone()
	{
		...
		// Calcul de l'empreinte carbone
		empreinteCarbone = super.getLeTypeVehicule().getTauxConsoKm() * super.getDistance() * FacteurEmission.MARITIME * (super.calculerVolumetotal() / super.getLeTypeVehicule().getVolumeMax());
